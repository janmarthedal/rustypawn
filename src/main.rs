mod board {
    ...
    pub fn init_game(fen: &str) -> Result<Game, &str> {
    ...
    pub fn unmake_move(game: &mut Game, mv: &Move, umv: UnMove) {
        let from = mv.m & 0xff;
        let to = (mv.m >> 8) & 0xff;
        let promoted = (mv.m >> 16) & 0xff;
...
mod perft {
    ...
    use super::board::generate_moves;
    use super::board::make_move;
    use super::board::unmake_move;
    use super::board::init_game;
